...
这个仓库沉淀的是从真实 AI 产品工作中抽象出来的、可公开使用的 Codex skills：单 Agent 工作流、RAG 导购、私域内容生产、安全数据更新、API 与浏览器自动化选型、AI 产品案例表达。
...
| `ai-product-case-storytelling` | 把 AI 产品、Agent、AI 搜索、AI 客服等项目整理成作品集/简历/面试案例，补齐指标、证据和追问回答。 |
| `RAG导购` | 构建有依据的导购能力，能解释推荐理由、对比选项，并避免编造事实。 |
| `单Agent工作流` | 设计由阶段、事件、工具、TODO、记忆和红线约束的单 Agent 工作流。 |
...
```text
使用 RAG导购 skill，为这个电商场景设计一个有依据的推荐流程。
```
